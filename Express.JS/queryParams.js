//pagination, filtration, sort, search
...
app.get("/product", (req,res) => { //we will still get empty object- req.query in case of single path type
    console.log(req.query);
    
    res.send(`<h1>Product Page</h1>`);
});
/*
For-product?search=kuch-nahi&search2=abhi-bhi-kuch-nhi
Output- [Object: null prototype] {
  search: 'kuch-nahi',
  search2: 'abhi-bhi-kuch-nhi'
}
  */
